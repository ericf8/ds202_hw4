...
data2018 = subset(dataClean, Year == "2018")

ggplot(data2018, aes(x = Date, y = Sale_.Dollars.)) + geom_bar(stat = "identity") + theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 4))
